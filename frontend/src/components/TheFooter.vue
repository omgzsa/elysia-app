...
<template>
  <footer class="divide-y bg-accent-100 dark:text-gray-100">
    ...
    >
      <div class="lg:w-1/3">
        <img
          :src="useGetImageUrl('elysia_logo_new_transparent_white.webp')"
          alt="Workflow"
          class="w-auto h-16"
        />
      </div>
      ...
      >
        <div class="space-y-3">
          <h3 class="tracking-wide uppercase dark:text-secondary-100">
            Product
          </h3>
          <ul class="space-y-1">
            <li>
        ...
        <div class="space-y-3">
          <h3 class="uppercase dark:text-secondary-100">Developers</h3>
          <ul class="space-y-1">
            <li>
    ...
    <div class="py-6 text-sm text-center text-white">
