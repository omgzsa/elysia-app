...
<template>
    <div class="employee-card group relative">
        ...
        >
            ...
            >
                <img
                    :src="`${apiUrl}/assets/${item.kep}?width=600&quality=85&format=webp`"
                    :alt="item.nev"
                    width="300"
                    height="300"
                    class="rounded-xl w-full h-64 object-cover mb-4 group-hover:-translate-y-1 transition-transform duration-200"
