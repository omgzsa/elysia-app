  ...
  <section class="relative">
    ...
    <Carousel v-bind="settings">
      <slide
        ...
        :key="slide.id"
        class="z-10 w-full bg-cover min-h-[90vh] sm:min-h-[720px] bg-no-repeat bg-right-bottom lg:min-h-[820px]"
        :style="{
          backgroundImage: `url(${useGetHeroImageUrl(getResponsiveImage(slide.id))})`,
        }"
      >
        <div
          class="grid max-w-screen-xl grid-cols-1 site-padding md:grid-cols-2"
        >
